...
export const EmailNotFoundException = () =>
  new UnprocessableEntityException([
    { message: AuthMessage.EMAIL_NOT_FOUND, path: 'email' },
  ]);

export const UserBannedException = () =>
  new ForbiddenException([{ message: AuthMessage.USER_BANNED, path: 'email' }]);
...
export const RefreshTokenRevokedException = () =>
  new UnauthorizedException([
    { message: AuthMessage.REFRESH_TOKEN_REVOKED, path: 'token' },
  ]);

export const EmailRequiredException = () =>
...
export const IncorrectEmailException = () =>
  new UnauthorizedException([
    { message: AuthMessage.INCORRECT_EMAIL, path: 'email' },
  ]);
