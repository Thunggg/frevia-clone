...
export class UpdateContractResponseDTO extends createZodDto(UpdateContractResponseSchema) { }
...
export class GetContractListQueryDTO extends createZodDto(GetContractListQuerySchema) { }
export class GetContractListResponseDTO extends createZodDto(GetContractListResponseSchema) { }
export class GetContractDetailResponseDTO extends createZodDto(ContractDetailSchema) { }
