...
export class MilestoneFileController {
    ...
    getMilestoneFiles(
        ...
        return this.milestoneFileService.getMilestoneFiles(userId, roleName, contractId, milestoneId);
    }
    ...
    uploadMilestoneFile(
        ...
        return this.milestoneFileService.uploadMilestoneFile(userId, contractId, milestoneId, file);
    }
    ...
    deleteMilestoneFile(
        ...
        return this.milestoneFileService.deleteMilestoneFile(userId, contractId, milestoneId, fileId);
    }
}
