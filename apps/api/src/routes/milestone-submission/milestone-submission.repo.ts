...
import { MilestoneStatus, MilestonePaymentStatus, Prisma, SubmissionStatus } from '@prisma/client';
...
export class MilestoneSubmissionRepository {
    ...
    async createSubmission(milestoneId: number, freelancerId: number, body: SubmitMilestoneBodyType) {
    ...
    async requestChanges(submissionId: number, milestoneId: number, body: RequestChangesBodyType) {
        return this.prisma.$transaction(async (tx) => {
