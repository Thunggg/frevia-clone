...
export class MilestoneController {
    ...
    getMilestoneList(
        ...
        return this.milestoneService.getMilestoneList(userId, roleName, contractId, query as GetMilestoneListQueryType);
    }
    ...
    getMilestoneDetail(
        ...
        return this.milestoneService.getMilestoneDetail(userId, roleName, contractId, milestoneId);
    }
    ...
    createMilestone(
        ...
        return this.milestoneService.createMilestone(userId, contractId, body as CreateMilestoneBodyType);
    }
    ...
    updateMilestone(
        ...
        return this.milestoneService.updateMilestone(userId, contractId, milestoneId, body as UpdateMilestoneBodyType);
    }
    ...
    progressMilestone(
        ...
        return this.milestoneService.progressMilestone(userId, contractId, milestoneId);
    }
    ...
    deleteMilestone(
        ...
        return this.milestoneService.deleteMilestone(userId, contractId, milestoneId);
    }
}
