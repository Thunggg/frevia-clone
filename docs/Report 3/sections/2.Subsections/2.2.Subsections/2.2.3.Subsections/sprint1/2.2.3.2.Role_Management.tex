...
Description: & \multicolumn{3}{L{11.1cm}|}{Allows administrators to create a new role by providing a name and an optional description. Permissions are assigned to the role separately through UC-13.6 Update Role Permissions.} \\ \hline
Preconditions: & \multicolumn{3}{L{11.1cm}|}{
\textbf{PRE-1} The user is authenticated as an Admin.
} \\ \hline
Post-conditions: & \multicolumn{3}{L{11.1cm}|}{
...
2. The system displays the Create Role form with fields for the role name and an optional description. \newline
3. Admin enters the role name and optional description. \newline
4. Admin clicks the ``Save'' button. \newline
5. The system validates the input data. \newline
6. The system creates a new record in the roles table. \newline
7. The system redirects the admin to the role detail page of the newly created role.
} \\ \hline
...
1. The system detects that the entered name matches a system role name (Admin, Client, or Freelancer). \newline
2. The system displays the message ``Cannot use a system role name.'' \newline
3. Return to step A.3.} \\ \hline
Exceptions: & \multicolumn{3}{L{11.1cm}|}{\textbf{EX-01 Database Connection Failure} \newline
1. The system fails to create the role. \newline
...
BR-RM-10: A role is created without permissions; route access is granted separately via UC-13.6 Update Role Permissions.
} \\ \hline
Other Information: & \multicolumn{3}{L{11.1cm}|}{
The newly created role has no permissions until they are assigned through the Assign Role page.
} \\ \hline
...
Description: & \multicolumn{3}{L{11.1cm}|}{Allows administrators to update a role's name and description. Permissions are revised separately through UC-13.6 Update Role Permissions.} \\ \hline
Preconditions: & \multicolumn{3}{L{11.1cm}|}{
\textbf{PRE-1} The user is authenticated as an Admin. \newline
\textbf{PRE-2} The selected role exists and has not been soft-deleted.
} \\ \hline
...
\textbf{POST-2} The role's assigned permissions and the users assigned to it are not affected by the update.
} \\ \hline
Normal Flow: & \multicolumn{3}{L{11.1cm}|}{
\textbf{A. Update Role} \newline
...
6. The system updates the role record in the roles table. \newline
7. The system displays the updated role detail page.
} \\ \hline
Alternative Flows: & \multicolumn{3}{L{11.1cm}|}{\textbf{A.2 Role Not Found} \newline
1. The system determines the role does not exist or is soft-deleted. \newline
2. The system displays the message ``Role not found.'' \newline
...
3. Return to step A.3.} \\ \hline
Exceptions: & \multicolumn{3}{L{11.1cm}|}{\textbf{EX-01 Database Connection Failure} \newline
1. The system fails to update the role. \newline
...
BR-RM-13: Updating a role's name or description shall not alter its assigned permissions or its users. \newline
...
The role name shown for users assigned to the role is updated along with the role record.
} \\ \hline
...
% =================================================================
% UC-13.6 Update Role Permissions
% =================================================================
\subparagraph{UC-13.6 Update Role Permissions}

{\singlespacing
\setlength{\extrarowheight}{4pt}
\begin{longtable}{|L{3.2cm}|L{4.1cm}|L{2.7cm}|L{4.1cm}|}
\hline
UC ID and Name & \multicolumn{3}{l|}{UC-13.6 Update Role Permissions} \\ \hline
\endfirsthead
\hline
\endhead
\hline
...
Description: & \multicolumn{3}{L{11.1cm}|}{Allows administrators to assign route access rights to a role by granting or revoking permissions. Each permission represents a server route defined by an HTTP method and path within a module. The system replaces the role's entire permission set with the newly selected permissions and the change takes effect immediately.} \\ \hline
Preconditions: & \multicolumn{3}{L{11.1cm}|}{
\textbf{PRE-1} The user is authenticated as an Admin. \newline
\textbf{PRE-2} The selected role exists and has not been soft-deleted. \newline
...
8. The system removes all existing permission associations of the role. \newline
9. The system creates new permission associations for the selected permissions. \newline
...
Other Information: & \multicolumn{3}{L{11.1cm}|}{
The Assign Role page lists permissions grouped by module and supports filtering by HTTP method and module. \newline
An empty permission set clears all route access for the role. \newline
Because replacement takes effect immediately, updating a role that is assigned to active users will alter their access rights without further confirmation.
} \\ \hline
