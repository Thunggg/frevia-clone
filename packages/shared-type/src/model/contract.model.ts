...
>;
export type GetContractListQueryType = z.infer<
  typeof GetContractListQuerySchema
>;
export type GetContractListResponseType = z.infer<
  typeof GetContractListResponseSchema
>;
